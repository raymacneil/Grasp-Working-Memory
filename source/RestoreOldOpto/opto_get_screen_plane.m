...
mkr_origin_rows = ((mkr_origin*3) + 1):((mkr_origin*3) + 3); % 4-6
mkr_xplane_rows = ((mkr_xplane*3) + 1):((mkr_xplane*3) + 3); % 7-9
mkr_xyplane_rows = ((mkr_xyplane*3) + 1):((mkr_xyplane*3) + 3); % 10-12
